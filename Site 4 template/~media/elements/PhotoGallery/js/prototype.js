 ...
 *
 *******************************************************************************************
 *  VERY IMPORTANT NOTE: this version of Prototype.js has been modified, so as not to conflict with the JQuery library
...
Function.prototype.bind = function() {
  var __method = this, args = PRA(arguments), object = args.shift();
  return function() {
...
var PRbreak    = new Object();
var PRcontinue = new Object();
...
var Enumerable = {
    ...
    try {
      this._each(function(value) {
        try {
          ...
          if (e != PRcontinue) throw e;
        }
      });
    } catch (e) {
      if (e != PRbreak) throw e;
    }
  },
  ...
  invoke: function(method) {
    var args = PRA(arguments).slice(1);
  ...
  zip: function() {
    var iterator = Prototype.K, args = PRA(arguments);
    if (typeof args.last() == 'function')
      iterator = args.pop();

    var collections = [this].concat(args).map(PRA);
...
var PRA = Array.from = function(iterable) {
  if (!iterable) return [];
  if (iterable.toArray) {
...
var PRR = function(start, end, exclusive) {
